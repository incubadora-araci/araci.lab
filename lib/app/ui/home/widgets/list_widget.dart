...
Widget buildList({String key, String string, BuildContext context}) {
  return Expanded(
    child: ListView(
      children: [
        homeCardWidget("Cosme Corrêa", "assets/testImages/CosmeCoffee.png", ()=> Get.snackbar("Card 1", "Card 1 selecionado", snackPosition: SnackPosition.BOTTOM), context),
        homeCardWidget("Volta Redonda", "assets/testImages/VR.jpg", ()=> Get.snackbar("Card 2", "Card 2 selecionado", snackPosition: SnackPosition.BOTTOM), context),
